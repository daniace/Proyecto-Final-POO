...
FORMACIONES = {
    "4-3-3": {
        "portero": [(0.45, 0.78)],
        "defensas": [(0.30, 0.55), (0.40, 0.57), (0.50, 0.57), (0.60, 0.55)],
        "mediocampistas": [(0.35, 0.33), (0.45, 0.35), (0.55, 0.33)],
        "delanteros": [(0.35, 0.12), (0.45, 0.10), (0.55, 0.12)],  # tupla: (ancho,alto)
    },
    "4-4-2": {
        "portero": [(0.47, 0.81)],
        "defensas": [(0.32, 0.58), (0.42, 0.60), (0.52, 0.60), (0.62, 0.58)],
        "mediocampistas": [(0.33, 0.35), (0.42, 0.38), (0.52, 0.38), (0.61, 0.35)],
        "delanteros": [(0.42, 0.14), (0.52, 0.14)],
    },
}
